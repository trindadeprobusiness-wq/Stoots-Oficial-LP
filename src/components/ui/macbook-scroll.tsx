...
export const MacbookScroll = ({
  ...
  return <div ref={ref} className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-80">
      <motion.h2 style={{
      translateY: textTransform,
      opacity: textOpacity
    }} className="mb-20 text-center text-3xl font-bold text-foreground">
        {title || <span>​<br /> No kidding.
          </span>}
      </motion.h2>
      {/* Lid */}
      <Lid src={src} scaleX={scaleX} scaleY={scaleY} rotate={rotate} translate={translate} children={children} />
      {/* Base area */}
...
export const Lid = ({
  ...
  return <div className="relative [perspective:800px]">
      ...
      transformOrigin: "top"
        ...
        {src ? <img src={src as string} alt="macbook screen" className="absolute inset-0 h-full w-full rounded-lg object-cover object-left-top" /> : <div className="absolute inset-0 h-full w-full rounded-lg overflow-auto p-4">
            {children}
          </div>}
      </motion.div>
    </div>;
...
export const OptionKey = ({
  ...
  return <svg fill="none" version="1.1" id="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className={className}>
